      ...
      <JsonLd
        data={[
          breadcrumbSchema([
            ...
            { name: property.title, url: localePath(locale, `/properties/${property.slug}`) },
          ]),
      ...
      <section className="bg-neutral-light py-8">
        <div className="container-custom px-4 sm:px-6 lg:px-8">
          <nav className="text-sm text-gray-500" aria-label="Breadcrumb">
            <Link href={localePath(locale, "/")} className="hover:text-primary">Home</Link>
            {" / "}
            <Link href={localePath(locale, "/properties")} className="hover:text-primary">Properties</Link>
            {" / "}
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-8">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Explore more in{" "}
                  <Link href={`${localePath(locale, "/areas")}#${property.areaSlug}`} className="text-primary hover:underline">
                    {property.area}
                  </Link>
                </p>
              </div>
