...
import { getAreas } from "@/data/locale";
...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return createMetadata({
    title: dict.areasPage.hero.title,
    description: dict.areasPage.hero.subtitle,
    path: "/areas",
    ...
    <>
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: dict.nav.areas, url: localePath(locale, "/areas") },
        ])}
      />
      ...
      <div>
        {areas.map((area, index) => (
          <AreaSection
            ...
            index={index}
            locale={locale}
            speakToLabel={dict.common.speakToConsultant}
          />
        ))}
      </div>
