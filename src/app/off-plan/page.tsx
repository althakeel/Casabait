              ...
              <AnimatedSection key={project.id}>
                <article className="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
                  ...
                  <div className="p-4">
                    ...
                    <Link href="/contact" className="mt-4 inline-flex min-h-[44px] w-full items-center justify-center rounded-md border border-primary text-sm font-medium text-primary transition-colors hover:bg-primary hover:text-white">
                      Enquire Now
                    </Link>
                  </div>
                </article>
